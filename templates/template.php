        ...
        <div class="container">
          <div class="row py-5" id="sitemap-row">
            ...
            <div class="col-md-4 col-sm-12">
              <h6 class="text-center mb-3" style="color: #c5a880;">Quick Links</h6>
            ...
            <div class="col-md-4 col-sm-12 pt-3" id="footerSocial">
              <h6 class="text-center mb-3" style="color: #c5a880;">Connect With Us</h6>
              <ul class="list-unstyled">
                <li class="d-inline"><a href="https://www.facebook.com" target="_blank"><i class="fab fa-facebook fa-2x"></i></a></li>
                <li class="d-inline"><a href="https://www.linkedin.com" target="_blank"><i class="fab fa-linkedin-in fa-2x px-3"></i></a></li>
                <li class="d-inline"><a href="https://www.instagram.com" target="_blank"><i class="fab fa-instagram fa-2x"></i></i></a></li>
              </ul>
              <div class="mt-3 text-center">
                <p class="mb-1" style="color: #C8C8C9; font-size: 0.9rem;">123 Pitt Street, Sydney NSW 2000</p>
                <p class="mb-1" style="color: #C8C8C9; font-size: 0.9rem;">Phone: 9000 1234</p>
                <p style="color: #C8C8C9; font-size: 0.9rem;">Email: info@lucasloaves.com.au</p>
              </div>
            </div>
          </div>
